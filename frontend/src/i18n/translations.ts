const de = {
  ...
  "settings.saveError": "Speichern fehlgeschlagen — läuft das Backend?",
  ...
  "detail.tabContent": "Inhalt",
  "detail.tabMetadata": "Metadaten",
  "detail.tabNotes": "Notizen",
  "detail.tabSimilar": "Ähnliche",
  "detail.notesPlaceholder": "Notizen kommen bald...",
  ...
  "detail.noContent": "Kein Textinhalt extrahiert",
  "detail.previewNotAvailable": "Vorschau nicht verfügbar für",
...
const en: Record<keyof typeof de, string> = {
  ...
  "settings.saveError": "Saving failed — is the backend running?",
  "settings.save": "Save",
  ...
  "detail.back": "Back",
  "detail.tabDetails": "Details",
  "detail.tabContent": "Content",
  "detail.tabMetadata": "Metadata",
  "detail.tabNotes": "Notes",
  "detail.tabSimilar": "Similar",
  "detail.notesPlaceholder": "Notes coming soon...",
  "detail.similarLoading": "Finding similar documents…",
  "detail.similarNotEmbedded": "No embedding exists for this document yet. Start the embedding job from the dashboard.",
  "detail.similarNone": "No similar documents found.",
  "detail.noContent": "No text content extracted",
  "detail.previewNotAvailable": "Preview not available for",
  ...
  "stats.embedBatch": "Generate embeddings",
